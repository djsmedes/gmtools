...
MIDDLEWARE = [
    ...
    '_config.middlewares.AuthenticationMiddleware',
    '_config.middlewares.CampaignMiddleware',
]
...
DATABASES = {
    'default': {
        'ENGINE': None,  # don't default to sqlite3 - some features might rely on postgres
        'NAME': None,
    }
}
